...
<template>
  <div class="terms-page section-py">
    <div class="container">
      <div class="prose">
        <h1>Terms & Conditions</h1>
        
        <p>These terms and conditions apply to the Sapid app for mobile devices and the website talantiq.com (hereby collectively referred to as "Application") that was created by Talentiq Solutions Inc. (hereby referred to as "Service Provider") as a Freemium service.</p>

        <p>Upon downloading or utilizing the Application or visiting the website, you are automatically agreeing to the following terms. It is strongly advised that you thoroughly read and understand these terms prior to using the Application.</p>
        ...
        <ul>
          ...
          <li><a href="https://www.facebook.com/legal/terms/plain_text_terms" target="_blank" rel="noopener">Facebook</a></li>
          <li><a href="https://sentry.io/terms/" target="_blank" rel="noopener">Sentry</a></li>
          <li><a href="https://mixpanel.com/legal/terms-of-use/" target="_blank" rel="noopener">Mixpanel</a></li>
          <li><a href="https://www.revenuecat.com/terms" target="_blank" rel="noopener">RevenueCat</a></li>
          <li><a href="https://clerk.com/terms" target="_blank" rel="noopener">Clerk</a></li>
        </ul>
        ...
        <p>These terms and conditions are effective as of 2026-01-27</p>

        <h2>Contact Us</h2>
        <p>If you have any questions or suggestions about the Terms and Conditions, please do not hesitate to contact the Service Provider at info@talantiq.com.</p>
        
        <hr />
        <p><small>This Terms and Conditions page was generated by <a href="https://app-privacy-policy-generator.nisrulz.com/" target="_blank" rel="noopener">App Privacy Policy Generator</a></small></p>
      </div>
    </div>
  </div>
</template>
